...
public class RButton extends JButton {
    ...
    public static final Color BUTTON_COLOR2 = Color.black;
...
//     public static final Color BUTTON_COLOR2 = new Color(91, 118, 173);
    ...
    public RButton(String name) {
        this.setText(name);
        setFont(new Font("ºÚÌå", Font.PLAIN, 20));
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.clip(r2d);
        GradientPaint gp = new GradientPaint(0.0F, 0.0F, BUTTON_COLOR1, 0.0F, h, BUTTON_COLOR1, true);
        g2d.setPaint(gp);
